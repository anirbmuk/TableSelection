 ...
 */
require(['ojs/ojcore', 'knockout', 'appController', 'jquery', 'ojs/ojknockout', 'ojs/ojbutton',
         'ojs/ojtoolbar', 'ojs/ojmenu', 'ojs/ojrouter', 'ojs/ojmodule', 'ojs/ojnavigationlist'],
  function (oj, ko, app, $) { // this callback gets executed when all required modules are loaded
    ...
    $(function() {
      ...
      function init() {
        ...
        oj.Router.sync().then(() => ko.applyBindings(app, document.getElementById('globalBody')));
      }
